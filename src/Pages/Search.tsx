	...
	return (
		<div className='absolute top-[calc(61px)] h-[calc(100vh-121px)] w-screen overflow-y-auto p-5'>
			<form onSubmit={onSubmit}>
				<div className='relative flex'>
					<button
						...
						className='z-10 inline-flex flex-shrink-0 items-center rounded-l-lg border border-gray-300 bg-gray-100 py-2.5 px-3 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700'
						type='button'
					>
						{filter === 'buy' ? '구해요' : '팔아요'}
					...
					{/* Dropdown */}
					{isDropdownOpen && (
						<div id='dropdown' className='absolute top-11 z-10 w-28 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700'>
			...
			<div className='mt-6 mb-4 flex items-center justify-between'>
				<div className='text-lg font-bold leading-none text-gray-900 dark:text-white'>검색 결과</div>
			</div>
