...
import { doc, DocumentData, setDoc, collection } from 'firebase/firestore';
...
const Comment = ({ id, comments, getComments }: CommentProps) => {
	...
	return (
		<div id='comments-container' className='z-20 w-full max-w-sm divide-y divide-gray-100 bg-white dark:divide-gray-700 dark:bg-gray-800'>
			...
			<ul className='divide-y divide-gray-100 dark:divide-gray-700'>
				{comments.map((comment) => (
					<li key={comment.commentId} className='flex px-4 py-3'>
